...
function  usarFunc() {
  if(qtdVezes >= 0){
    ...
    elemento.innerHTML = elemento.innerHTML + '<img class="topChads-class" src="https://www.idlememe.com/wp-content/uploads/2021/09/chad-meme-idlememe-8.jpg"></img>'
    elemento.innerHTML = elemento.innerHTML + '<img class="topChads-class" src="https://i.imgflip.com/76en3i.jpg"></img>'
    elemento.innerHTML = elemento.innerHTML + '<img class="topChads-class" src="https://www.meme-arsenal.com/memes/d7aac160fc9b12cf6c792b31cf063dd3.jpg"></img>'
